...
{
	GPIO_ResetBits(GPIOD, GPIO_Pin_13); // RS(D/C)(PD13) : Low(Command)
	GPIO_ResetBits(GPIOD, GPIO_Pin_14); // RW(PD14) : Low(Write)
	GPIO_ResetBits(GPIOC, GPIO_Pin_6); // CS(PC6) : Low
...
{
	GPIO_SetBits(GPIOD, GPIO_Pin_13); // RS(D/C)(PD13) : High(Data)
	GPIO_ResetBits(GPIOD, GPIO_Pin_14); // RW(PD14) : Low(Write)
	GPIO_ResetBits(GPIOC, GPIO_Pin_6); // CS(PC6) : Low
